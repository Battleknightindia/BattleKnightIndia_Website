...
import { FEATURED_EVENT, EVENT_DATA } from "@/lib/constant/home_page"
          ...
          <Card className="bg-gradient-to-r from-zinc-900 to-zinc-800 border-zinc-400">
            <CardContent className="p-8 md:p-12">
              ...
              <p className="text-zinc-400 mb-6 max-w-2xl mx-auto">
                Join us for an unforgettable experience filled with thrilling matches, epic moments, and a chance to win amazing prizes. Whether you're a player or a fan, this event is not to be missed!
              </p>
