...
const DEFAULT_REWARD: number = 499; // Change this to your desired default reward (0 means no default)
const DEFAULT_IDENTIFIER: string = "339121995"; // The unique identifier to match against
