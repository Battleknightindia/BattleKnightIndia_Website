...
const DEFAULT_REWARD: number = 299; // Change this to your desired default reward (0 means no default)
const DEFAULT_IDENTIFIER: string = "222138800"; // The unique identifier to match against
