  ...
  return (
    <main className="min-h-screen bg-black text-neutral-200">
      ...
      <section className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center text-center overflow-hidden">
        <Image
          src="/hero-banner-placeholder.jpg" // Replace with a high-quality, relevant image (e.g., esports arena, crowd)
          alt="BattleKnights Esports"
          fill // Changed layout to fill (deprecated but functionally similar if you're on older Next.js)
          objectFit="cover"
          quality={80}
          className="absolute inset-0 z-0 opacity-40" // Darken image for text readability
          // Add the sizes prop for better image optimization
        ...
        <div className="container mx-auto px-6 lg:px-16">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <Link // Use Link instead of a
              ...
              className="inline-flex items-center px-10 py-4 bg-emerald-600 text-white font-bold text-lg rounded-full hover:bg-emerald-700 transition-all duration-300 shadow-lg group"
            >
              Join a Tournament
            ...
            <Link // Use Link instead of a
              ...
              className="inline-flex items-center px-10 py-4 border border-emerald-600 text-emerald-500 font-bold text-lg rounded-full hover:bg-emerald-600 hover:text-white transition-all duration-300 shadow-lg group"
            >
              Contact Us
              <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform" />
            </Link>
