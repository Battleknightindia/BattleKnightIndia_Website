        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Tournament ended on {tournament.tournamentEndDate}</p>
            </div>

            <div className="flex items-center gap-2">
              <Users className="h-4 w-4 text-blue-500" />
              <p className="text-sm text-muted-foreground">Team Slot was {tournament.teamSlots}</p>
            </div>
            <div className="flex items-center gap-2">
              <Users className="h-4 w-4 text-blue-500" />
              <p className="text-sm text-muted-foreground">{tournament.total_participants} Team Participated</p>
            </div>
          </div>
        </div>
