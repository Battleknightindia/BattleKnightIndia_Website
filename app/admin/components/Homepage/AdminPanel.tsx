...
import { FeaturedSectionAdmin } from "./FeaturedForm";
import { EventCarouselAdmin } from "./EventCardForm";
import { NorthEastCupAdmin } from "./NorthEastCupForm";
import { CosplaySectionAdmin } from "./CosplayForm";
import {
  insertTournament,
  updateTournament,
  deleteTournament,
...
import { uploadHomepageImage } from "@/lib/services/storageService"; // Updated path
import TeamList from "../Stats/TeamList";
  ...
  async function handleAddTournament(e: React.FormEvent) {
    ...
    try {
      ...
      if (success) {
        ...
        toast({
          title: "Error",
          description: "Failed to fetch and refresh the data",
          variant: "destructive",
        });
      }
    } catch (error) {
